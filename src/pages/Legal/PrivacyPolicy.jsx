    ...
    return (
        <div className="page-wrapper legal-page">
            <main className="legal-content">
                ...
                <section>
                    <h2>14. Contact Us</h2>
                    <p>If you have any questions, concerns, or requests regarding this Privacy Policy, your personal data, or our data practices, please contact us at <a href="mailto:example@example.com" target="_blank" rel="noopener noreferrer">example@example.com</a>.</p>
                </section>
            </main>
        </div>
    );
