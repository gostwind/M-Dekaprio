...
const WatchlistDropdown = ({ movie, customClass = '', compact = false }) => {
    ...
    if (compact) {
        return (
            <div className={`watchlist-dropdown-container compact ${customClass}`} ref={dropdownRef}>
                <button
                    className={`watchlist-btn-compact ${isListed ? 'active' : ''}`}
                    onClick={(e) => {
                        e.stopPropagation();
                        setIsOpen(!isOpen);
                    }}
                    title={isListed ? activeOption?.label : 'Add to List'}
                >
                    {isListed ? (
                        <span className="compact-icon">{activeOption?.icon}</span>
                    ) : (
                ...
                {isOpen && (
                    <div className="watchlist-dropdown-menu watchlist-dropdown-menu--compact">
                        ...
                        {isListed && (
                            <div className="menu-group border-top">
                                <button className="menu-item remove" onClick={(e) => { e.stopPropagation(); handleToggleRemove(e); }}>
